...
class EventActionCardUi extends RectangleComponent
    with DragCallbacks, TapCallbacks {
  late final Paint _paint;
  late final EventActionCard _eventCard;

  EventActionCardUi({required Vector2 pos, required EventActionCard eventCard})
